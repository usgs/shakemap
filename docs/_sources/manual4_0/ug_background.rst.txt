...
the central government in Tokyo until many hours later
(e.g., :ref:`Yamakawa, 1998 <yamakawa1998>`),
...
producing maps of response spectral acceleration that are not particularly
...
:ref:`technical-guide-4` for more details).

Seismic station locations are the best indicator of where the map is most accurate: near
stations, the shaking is well constrained by data; far from such
...
outlier or clipped flag codes are provided in the :ref:`technical-guide-4`. Peak
...
and 3.0 sec. Additional spectral periods and other seismic parameters (e.g.,
duration or Arias intensity) are possible within the ShakeMap framework, and
we are constantly evaluating the best ways to represent earthquake shaking.
