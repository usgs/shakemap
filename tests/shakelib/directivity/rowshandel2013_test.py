...
def test_exceptions():
    ...
    with pytest.raises(Exception) as e:  # noqa
        Rowshandel2013(
            origin, rup, slat, slon, deps, dx=1, T=[1.0, 3.0], a_weight=1.5, mtype=1
        )

    with pytest.raises(Exception) as e:  # noqa
        Rowshandel2013(
            origin, rup, slat, slon, deps, dx=1, T=[1.0, 3.0], a_weight=0.5, mtype=3
        )
...
def test_ss3():
    ...
    test1 = Rowshandel2013(
        origin, rup, slat, slon, deps, dx=1, T=[1.0, 3.0], a_weight=0.5, mtype=1
    )
    # Test xiprime
    ...
    test1 = Rowshandel2013(
        origin, rup, slat, slon, deps, dx=1, T=[5.0], a_weight=0.5, mtype=2
    )
    targetFd = np.array(
        [
            [
...
def test_rv4():
    ...
    test1 = Rowshandel2013(
        origin, rup, slat, slon, deps, dx=1, T=5.0, a_weight=0.5, mtype=1
    )
...
def test_so6():
    ...
    test1 = Rowshandel2013(
        origin, rup, slat, slon, sdepth, dx=1, T=5.0, a_weight=0.5, mtype=1
    )
    fd = test1.getFd()[0]
    fd_test = np.array(
        [
