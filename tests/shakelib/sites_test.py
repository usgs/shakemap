...
def test_sites(vs30file=None):
    ...
    mysite = Sites.fromBounds(xmin, xmax, ymin, ymax, dx, dy,
                              ...
                              resample=False)
    grd = mysite.getVs30Grid().getData()
    grd_target = np.array([[428.2287, 427.0027, 426.89514, 425.62024,
                            419.60953, 411.79617, 407.5351, 406.22122,
                            405.31622, 402.92575],
                           [429.40097, 427.7418, 427.00006, 419.50626,
                            411.1083, 407.489, 406.53305, 406.5966, 406.24887,
                            406.17044],
                           [429.4397, 427.30435, 425.96152, 426.15857,
                            427.56122, 397.67102, 399.21054, 404.54968,
                            407.18515, 410.00824],
                           [428.8627, 425.99606, 423.56927, 423.59836,
                            425.92758, 408.44885, 406.5581, 409.06946,
                            413.7521, 417.7113],
                           [427.91104, 424.53796, 419.47485, 418.17795,
                            424.14066, 428.57913, 432.953, 427.7773, 431.46524,
                            442.7554],
                           [423.15558, 424.48355, 419.27658, 418.6021,
                            423.86722, 428.06177, 432.4209, 438.54446,
                            448.37238, 462.2551]],
                          dtype=np.float32)
