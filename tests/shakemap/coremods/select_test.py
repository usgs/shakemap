...
def test_select():
    ...
    conf_file = os.path.join(datapath, "nc72282711", "current", "model_select.conf")
    ...
    conf_file = os.path.join(datapath, "usp0004bxs", "current", "model_select.conf")
    ...
    conf_file = os.path.join(datapath, "northridge2", "current", "model_select.conf")
    if os.path.isfile(conf_file):
        os.remove(conf_file)
    try:
