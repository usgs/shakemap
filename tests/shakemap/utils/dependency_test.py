...
from shakemap.utils.dependencies import (sha_sum,
                                         DepNode,
                                         CommandDatabase)
...
file_list = {'config': ['module1a.conf', 'module2a.conf',
                        'module1b.conf', 'module2b.conf'],
             os.path.join('dummy_event', 'current'): ['module1_dep1.txt',
                                                      'module1_dep2.txt'],
...
def test_command_database():
    ...
    classes = {module1.command_name: {'class': module1, 'mfile': mod1_path},
